...
Our lab works on bioinformatics, mass spectrometry, and proteomics technologies as part of the [Department of Quantitative Health Sciences](https://www.mayo.edu/research/departments-divisions/quantitative-health-sciences/overview) at [the Mayo Clinic](https://www.mayo.edu). We are interested in developing new methods that improve all aspects of the proteomics workflow, from data acquisition, to computational quantitation and statistical analysis. We are dedicated to open methods and open source software, as well as the long-term support for those computational resources for the proteomics and mass spectrometry communities.
